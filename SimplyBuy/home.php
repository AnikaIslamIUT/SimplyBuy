...
<body>
  ...
  background: -webkit-linear-gradient(#001E6C, #1572A1);
  -webkit-background-clip: text;
  -webkit-text-fill-color: transparent;">Easy and Safe Shopping
					<br> From Home !!</h1>
					<p>Pick what you Desire most</p>
					<a href="#TrendingCategories" class ="Button">Lets Get Started</a>
				</div>
				<div class="TwinColumn">
					<img style="height: 700px;;" src="HappyShopper.jpeg">
				</div>
			</div>
 
		<div style="background:#00264d" id="TrendingCategories" class="Categories">  <!--Connect With Other web Pages-->
		<h1 style="padding-top:5%;padding-bottom:5%;color:#abdbe3">TrendingCategories</h1>
	    ...
	    ?>
		<div style="background: #98BAE7;width:100%" class="SmallContainer">
