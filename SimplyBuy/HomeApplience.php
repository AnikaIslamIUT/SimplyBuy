...
<div class="Body">
    ...
    <div class="SmallContainer">
        ...
        <div class="row row-2">
            ...
            <ul>
                <li><a href="Homeapplience.php?sort=default">Default Sorting</a></li>
                <li><a href="Homeapplience.php?sort=price">Sort by price</a></li>
                <li><a href="Homeapplience.php?sort=rating">Sort by rating</a></li>
            </ul>
        </div>
    ...
    if($productSort=="default"){
        $sql = "SELECT * From product WHERE Category = 'homeApplience' ;" ;
    }
    else if($productSort=="price"){
        $sql = "SELECT * From product WHERE Category = 'homeApplience' ORDER BY Price ASC;" ;
    }
    else if($productSort=="rating"){
        $sql = "SELECT * From product WHERE Category = 'homeApplience'    ORDER BY Rating DESC;" ;
    }
