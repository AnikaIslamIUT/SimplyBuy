...
<div class="row row-2">
    ...
    <ul>
        <li><a href="FashionProduct.php?sort=default">Default Sorting</a></li>
        <li><a href="FashionProduct.php?sort=price">Sort by price</a></li>
        <li><a href="FashionProduct.php?sort=rating">Sort by rating</a></li>
    </ul>
</div>
...
$sql = "SELECT * From product WHERE Category = 'fashionClothing' ;" ;
}
else if($productSort=="price"){
$sql = "SELECT * From product WHERE Category = 'fashionClothing' ORDER BY Price ASC;" ;
}
else if($productSort=="rating"){
$sql = "SELECT * From product WHERE Category = 'fashionClothing' ORDER BY Rating DESC;" ;
}
